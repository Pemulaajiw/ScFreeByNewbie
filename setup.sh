...
REPO2="https://raw.githubusercontent.com/Pemulaajiw/ScFreeByNewbie/main/"
function CEKIP () {
...
clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To NEWBIE VPN Script FREE Installer ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
...
echo "SCRIPT FREE BY NEWBIE" > /etc/xray/username
...
function key2(){
    [[ ! -f /usr/bin/git ]] && apt install git -y &> /dev/null
        ...
        wget -qO /etc/github/api "https://raw.githubusercontent.com/Pemulaajiw/script/main/config/rclone.conf" &> /dev/null
        curl -s ajiw63871@gmail.com > /etc/github/email
        curl -s Pemulaajiw > /etc/github/username
        clear
...
TIMES="10"
CHATID="6197482164"
KEY="7124749210:AAHy_9RMxkY6JKcqwA3bVOqcfxtpbhUX0CI"
...
TEXT="
<code>━━━━━━━━━━━━━━━━━━━━</code>
<code>⚠️ AUTOSCRIPT BY NEWBIE ⚠️</code>
<code>━━━━━━━━━━━━━━━━━━━━</code>
