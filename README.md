...
### INSTALL SCRIPT 
<pre><code>apt update -y && apt install -y wget curl screen sudo && wget -q https://raw.githubusercontent.com/Pemulaajiw/ScFreeByNewbie/main/setup.sh && chmod +x setup.sh && screen -S install ./setup.sh
</code></pre>

### PERINTAH UPDATE 
<pre><code>wget -q https://raw.githubusercontent.com/Pemulaajiw/ScFreeByNewbie/main/update.sh && chmod +x update.sh && ./update.sh</code></pre>
